exp_name = 'pg_ia_nilut_ppr10k_a_second'
...
model = dict(
    ...
    pretrained_path="work_dirs/pg_ia_nilut_ppr10k_a_first/iter_88750.pth",
    pg_loss_freq=10,
    param_scale=10,
    classnames=[
...
# learning policy
total_iters = 8875 * 250 //data["train_dataloader"]["samples_per_gpu"]

checkpoint_config = dict(interval=8875, save_optimizer=True, by_epoch=False)
evaluation = dict(interval=8875, save_image=False)
log_config = dict(
    interval=100,
    hooks=[
