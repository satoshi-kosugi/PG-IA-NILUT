exp_name = 'pg_ia_nilut_ppr10k_a_third'
...
model = dict(
    ...
    pretrained_PG_IA_NILUT_path="work_dirs/pg_ia_nilut_ppr10k_a_second/iter_***.pth")
...
data = dict(
    ...
    train=dict(
        ...
        dir_lq='data/PPR10K/train_val_images_tif_360p/source_aug_6',
